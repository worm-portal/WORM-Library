...
conda run -n python3 pytest --nbval 3-Aqueous-Speciation/1-Introduction-to-Aq-Speciation/2-Multi-Sample-Speciation/Multi-Sample-Speciation.ipynb
conda run -n python3 pytest --nbval 3-Aqueous-Speciation/1-Introduction-to-Aq-Speciation/3-Charge-Balancing/Charge-Balancing.ipynb
